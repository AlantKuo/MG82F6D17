/*********************************************************************
	...
	Description:
			...
			CH0(P22),CH1(P33)
			晚朓勤ょ,煦望薹峈1000
			PWMけ薹: PCAClk/(1000)=32MHz/1000=32KHz
	Note:
...
void InitUart1(void)
{
    ...
    UART1_SetRxTxP10P11();//UART1_SetRxTxP34P35();									// UART1 PinㄩRX:P34 TX:P35
	UART1_EnReception();									// Enable reception
	UART1_SetS1BRGSelSYSCLK();								// S1BRG clock sourceㄩSYSCLK
